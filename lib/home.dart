...
import 'package:biodataform/details.dart';
import 'package:biodataform/models/msiswa.dart';
import 'package:biodataform/models/api.dart';

import 'package:http/http.dart' as http;
import 'package:biodataform/tambah_form.dart';
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return Card(
                    child: ListTile(
                      ...
                      subtitle: Text(data.tplahir + ". "+data.alamat +", " + data.tglahir),
                      onTap: () {
